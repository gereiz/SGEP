        ...
        window.themeSettings = new ThemeSettings({
            ...
            pathResolver: function(path) {
                var resolvedPaths = {
                    ...
                    '{{ $name }}.css': '{{ asset("/vendor/css/rtl/{$name}.css") }}',
                    '{{ $name }}-material.css': '{{ asset("/vendor/css/rtl/{$name}-material.css") }}',
                    @endforeach

                    // UI Kit
                    'uikit.css': '{{ asset("/vendor/css/rtl/uikit.css") }}',

                    // Themes
                    //
                    @foreach (['air', 'corporate', 'cotton', 'gradient', 'paper', 'shadow', 'soft', 'sunrise', 'twitlight', 'vibrant'] as $name)
                    'theme-{{ $name }}.css': '{{ asset("/vendor/css/rtl/theme-{$name}.css") }}',
                    'theme-{{ $name }}-material.css': '{{ asset("/vendor/css/rtl/theme-{$name}-material.css") }}',
                    @endforeach
                }
